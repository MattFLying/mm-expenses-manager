...
/**
 * Country two digits code, three digits code and numeric according to ISO 3166-1
 */
@Getter
@RequiredArgsConstructor
public enum CountryCode {
    UNDEFINED("Undefined", StringUtils.EMPTY, -1),
    AD("Andorra", "AND", 20),
    ...
    private final String threeDigitsAbbreviation;
