...
@Component
class ProductFilterViewSpecificationHandler extends SpecificationHandler<ProductFilterView> {

    private final SpecificationCriteria criteria;

    ProductFilterViewSpecificationHandler(@Autowired final PaginationConfig paginationConfig) {
