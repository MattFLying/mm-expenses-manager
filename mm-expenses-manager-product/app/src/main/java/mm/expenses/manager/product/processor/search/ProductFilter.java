...
public class ProductFilter extends EntityFilter {
    ...
    public static final String PRICE_VALUE_PROPERTY = "price.value";
    public static final String PRICE_VALUE_OPERATION_PROPERTY = "priceValueOperation";

    public static final String PRICE_CURRENCY_PROPERTY = "price.currency";
    public static final String PRICE_CURRENCY_OPERATION_PROPERTY = "priceCurrencyOperation";
