...
class LatestCacheRedisTest extends FinanceApplicationTest {
    ...
    private LatestCacheRedis latestCacheRedis;
    ...
    protected void setupBeforeEachTest() {
        ...
        this.latestCacheRedis = new LatestCacheRedis(currencyRatesConfig, exchangeRateService, exchangeRateCacheService);
    }
    ...
    void shouldRetrieveRedisCacheType() {
        assertThat(latestCacheRedis.cacheType()).isEqualTo(LatestCacheInit.CacheType.REDIS);
    }
    ...
    class SaveInMemory {
        ...
        void shouldSaveInMemory_whenNoCacheExist() {
            ...
            final var currency_2 = CurrencyCode.CAD;
            ...
            latestCacheRedis.saveInMemory();

            // then
            for (var result : latestCacheRedis.getLatest()) {
        ...
        void shouldSaveInMemory_whenCacheIsUpToDateThenSkip() {
            ...
            final var currency_1 = CurrencyCode.EUR;
            final var id_1 = UUID.randomUUID().toString();
            final var rate_1 = ExchangeRateHelper.createNewRandomRateToPLN(currency_1);
        ...
        void shouldSaveInMemory_whenCacheHasRateThenDisableLatestAndSaveFresh() {
            ...
            final var currency_2 = CurrencyCode.SEK;
            final var id_2 = UUID.randomUUID().toString();
            final var rate_2 = ExchangeRateHelper.createNewRandomRateToPLN(currency_1);
    ...
    class GetLatest {
        ...
        void shouldGetAllLatest() {
            ...
            final var result = latestCacheRedis.getLatest();
        ...
        void shouldGetLatestForCurrency(final CurrencyCode currency) {
            ...
            final var result = latestCacheRedis.getLatest(currency);
        ...
        void shouldGetLatest() {
            ...
            final var result = latestCacheRedis.getLatest(Set.of(currency_1, currency_2));
