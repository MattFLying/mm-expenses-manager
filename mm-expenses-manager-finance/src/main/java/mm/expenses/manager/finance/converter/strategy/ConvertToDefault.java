...
class ConvertToDefault extends BaseConversion {
    ...
    ConvertToDefault(final ExchangeRateService exchangeRateService, final ExchangeRateCacheService exchangeRateCacheService, final LatestRatesCache latestRatesCache, final CurrencyRatesConfig config) {
