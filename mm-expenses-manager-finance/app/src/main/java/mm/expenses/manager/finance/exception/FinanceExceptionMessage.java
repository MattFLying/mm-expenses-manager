...
import mm.expenses.manager.finance.currency.CurrencyExceptionMessage;
...
public enum FinanceExceptionMessage implements ExceptionType {
    // currency
    CURRENCY_NOT_ALLOWED(CurrencyExceptionMessage.CURRENCY_NOT_ALLOWED),
    DEFAULT_CURRENCY_NOT_ALLOWED(CurrencyExceptionMessage.DEFAULT_CURRENCY_NOT_ALLOWED),
    ...
    FinanceExceptionMessage(ExceptionType exceptionType) {
