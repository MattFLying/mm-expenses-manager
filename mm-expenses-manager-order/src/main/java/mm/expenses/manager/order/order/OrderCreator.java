...
class OrderCreator {
    ...
    Optional<Order> create(final CreateNewOrder newOrder) {
    ...
    List<OrderedProduct> createOrderedProducts(final List<CreateNewOrderedProduct> newProductOrders) {
        final var productIds = newProductOrders.stream().map(CreateNewOrderedProduct::getProductId).collect(Collectors.toSet());
