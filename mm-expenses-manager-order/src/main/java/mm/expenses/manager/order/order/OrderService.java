...
public class OrderService {
    ...
    Page<Order> findAll(final Pageable pageable) {
        ...
        return new PageImpl<>(result.stream().map(mapper::map).collect(Collectors.toList()), pageable, result.getTotalElements());
    }
    ...
    Optional<Order> update(final String id, final UpdateOrder updateProduct) {
