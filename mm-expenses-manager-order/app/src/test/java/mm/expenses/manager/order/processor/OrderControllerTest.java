...
import static mm.expenses.manager.order.processor.OrderHelper.*;
...
class OrderControllerTest extends OrderApplicationTest {
    ...
    class FindAll {
        ...
        void shouldFindAll() throws Exception {
            ...
            // then
            mockMvc.perform(MockMvcRequestBuilders.get("/orders").contentType(DATA_FORMAT_JSON))
                    ...
                    .andExpect(jsonPath("$.content[0].orderedProducts[0].createdAt").isNotEmpty())
                    ...
                    .andExpect(jsonPath("$.content[0].orderedProducts[0].price[0].value", is(expectedOrderResult.getProducts().get(0).getPrices().get(0).getValue().doubleValue())))
                    .andExpect(jsonPath("$.content[0].orderedProducts[0].price[0].currency", is(expectedOrderResult.getProducts().get(0).getPrices().get(0).getCurrency().toString())))
                    .andExpect(jsonPath("$.content[0].orderedProducts[0].price[0].isOriginal", is(expectedOrderResult.getProducts().get(0).getPrices().get(0).isPriceOriginal())))
        ...
        void shouldFindAll_onlyDeleted() throws Exception {
            ...
            // then
            mockMvc.perform(MockMvcRequestBuilders.get("/orders").param(OrderFilter.IS_DELETED_PROPERTY, Boolean.TRUE.toString()).contentType(DATA_FORMAT_JSON))
                    .andExpect(MockMvcResultMatchers.content().contentType(DATA_FORMAT_JSON))
                    .andExpect(MockMvcResultMatchers.status().isOk())
                    ...
                    .andExpect(jsonPath("$.content[0].orderedProducts[0].price", hasSize(1)))
                    .andExpect(jsonPath("$.content[0].orderedProducts[0].price[0].value", is(expectedOrderResultDeleted.getProducts().get(0).getPrices().get(0).getValue().doubleValue())))
                    .andExpect(jsonPath("$.content[0].orderedProducts[0].price[0].currency", is(expectedOrderResultDeleted.getProducts().get(0).getPrices().get(0).getCurrency().toString())))
                    .andExpect(jsonPath("$.content[0].orderedProducts[0].price[0].isOriginal", is(expectedOrderResultDeleted.getProducts().get(0).getPrices().get(0).isPriceOriginal())))
        ...
        void shouldFindAll_shouldConvertCurrencyFlag(final CurrencyCode currencyCode) throws Exception {
            ...
            // then
            mockMvc.perform(MockMvcRequestBuilders.get("/orders").param(OrderFilter.SHOULD_CONVERT_CURRENCY_PROPERTY, Boolean.TRUE.toString()).contentType(DATA_FORMAT_JSON))
                    .andExpect(MockMvcResultMatchers.content().contentType(DATA_FORMAT_JSON))
                    .andExpect(MockMvcResultMatchers.status().isOk())
        ...
        void shouldFindAll_byName(final TextOperationRequest operation) throws Exception {
            ...
            // then
            mockMvc.perform(MockMvcRequestBuilders.get("/orders").param(OrderFilter.NAME_PROPERTY, ORDER_NAME).param(OrderFilter.NAME_OPERATION_PROPERTY, operation.name()).contentType(DATA_FORMAT_JSON))
                    .andExpect(MockMvcResultMatchers.content().contentType(DATA_FORMAT_JSON))
                    .andExpect(MockMvcResultMatchers.status().isOk())
        ...
        void shouldFindAll_byProductsCount(final NumberOperationRequest operation) throws Exception {
            ...
            // then
            mockMvc.perform(MockMvcRequestBuilders.get("/orders").param(OrderFilter.PRODUCTS_COUNT_PROPERTY, String.valueOf(productsCount)).param(OrderFilter.PRODUCTS_COUNT_OPERATION_PROPERTY, operation.name()).contentType(DATA_FORMAT_JSON))
                    .andExpect(MockMvcResultMatchers.content().contentType(DATA_FORMAT_JSON))
                    .andExpect(MockMvcResultMatchers.status().isOk())
        ...
        void shouldFindAll_byNameAndProductsCount(final TextOperationRequest textOperation, final NumberOperationRequest numberOperationRequest) throws Exception {
            ...
            // then
            mockMvc.perform(MockMvcRequestBuilders.get("/orders").param(OrderFilter.NAME_PROPERTY, String.valueOf(productsCount)).param(OrderFilter.NAME_OPERATION_PROPERTY, textOperation.name())
    ...
    class FindOrderById {
        ...
        void shouldFindOrderByIdAndDefaultNotDeleted() throws Exception {
            ...
            // then
            mockMvc.perform(MockMvcRequestBuilders.get("/orders" + "/" + expectedOrderResult.getId().toString()).contentType(DATA_FORMAT_JSON))
                    .andExpect(MockMvcResultMatchers.content().contentType(DATA_FORMAT_JSON))
                    .andExpect(MockMvcResultMatchers.status().isOk())
                    ...
                    .andExpect(jsonPath("$.orderedProducts[0].createdAt").isNotEmpty())
                    .andExpect(jsonPath("$.orderedProducts[0].lastModifiedAt").isNotEmpty())

                    .andExpect(jsonPath("$.orderedProducts[0].price", hasSize(1)))
                    .andExpect(jsonPath("$.orderedProducts[0].price[0].value", is(expectedOrderResult.getProducts().get(0).getPrices().get(0).getValue().doubleValue())))
                    .andExpect(jsonPath("$.orderedProducts[0].price[0].currency", is(expectedOrderResult.getProducts().get(0).getPrices().get(0).getCurrency().toString())))
                    .andExpect(jsonPath("$.orderedProducts[0].price[0].isOriginal", is(expectedOrderResult.getProducts().get(0).getPrices().get(0).isPriceOriginal())))
        ...
        void shouldFindOrderByIdAndIsDeleted() throws Exception {
            ...
            // then
            mockMvc.perform(MockMvcRequestBuilders.get("/orders" + "/" + expectedOrderResult.getId().toString()).param(OrderFilter.IS_DELETED_PROPERTY, String.valueOf(true)).contentType(DATA_FORMAT_JSON))
                    .andExpect(MockMvcResultMatchers.content().contentType(DATA_FORMAT_JSON))
                    .andExpect(MockMvcResultMatchers.status().isOk())
                    .andExpect(jsonPath("$.id", is(expectedOrderResult.getId().toString())))
                    .andExpect(jsonPath("$.name", is(expectedOrderResult.getName())))
        ...
        void shouldFindOrderByIdAndIsNotDeleted() throws Exception {
            ...
            // then
            mockMvc.perform(MockMvcRequestBuilders.get("/orders" + "/" + expectedOrderResult.getId().toString()).param(OrderFilter.IS_DELETED_PROPERTY, String.valueOf(false)).contentType(DATA_FORMAT_JSON))
                    .andExpect(MockMvcResultMatchers.content().contentType(DATA_FORMAT_JSON))
                    .andExpect(MockMvcResultMatchers.status().isOk())
                    .andExpect(jsonPath("$.id", is(expectedOrderResult.getId().toString())))
                    .andExpect(jsonPath("$.name", is(expectedOrderResult.getName())))
        ...
        void shouldNotFindOrderById() throws Exception {
            mockMvc.perform(MockMvcRequestBuilders.get("/orders" + "/" + ID).contentType(DATA_FORMAT_JSON))
        ...
        void shouldFindOrderById_shouldConvertProductAndOrderCurrencyToDefaultCurrency(final CurrencyCode currency) throws Exception {
            ...
            final var request = OrderHelper.createOrderRequest(ORDER_NAME, expectedProduct);
            final var expectedOrder = OrderHelper.createOrderFromOrderRequest(request, expectedProduct);
            final var expectedOrderResult = OrderHelper.createOrderFromOrder(expectedOrder, DEFAULT_CURRENCY);
            final var expectedConvertedCurrencyResponse = OrderHelper.createCurrencyConversionResponse(expectedProduct);

            // when
            Mockito.when(orderRepository.findByIdAndIsDeleted(ArgumentMatchers.any(), ArgumentMatchers.anyBoolean())).thenReturn(Optional.of(expectedOrder));
            ...
            // then
            mockMvc.perform(MockMvcRequestBuilders.get("/orders" + "/" + expectedOrder.getId().toString()).param(OrderFilter.SHOULD_CONVERT_CURRENCY_PROPERTY, String.valueOf(true)).contentType(DATA_FORMAT_JSON))
                    .andExpect(MockMvcResultMatchers.content().contentType(DATA_FORMAT_JSON))
                    .andExpect(MockMvcResultMatchers.status().isOk())
                    .andExpect(jsonPath("$.id", is(expectedOrderResult.getId().toString())))
                    .andExpect(jsonPath("$.name", is(expectedOrderResult.getName())))
                    ...
                    .andExpect(jsonPath("$.priceSummary", hasSize(1)))
                    .andExpect(jsonPath("$.priceSummary[0].value").value(expectedOrderResult.getPriceSummary().stream().filter(price -> price.hasCurrency(DEFAULT_CURRENCY)).findAny().get().getValue().doubleValue()))
                    .andExpect(jsonPath("$.priceSummary[0].currency", is(expectedOrderResult.getPriceSummary().stream().filter(price -> price.hasCurrency(DEFAULT_CURRENCY)).findAny().get().getCurrency().toString())))
                    ...
                    .andExpect(jsonPath("$.orderedProducts[0].price", hasSize(1)))
                    .andExpect(jsonPath("$.orderedProducts[0].price[0].value", is(expectedOrderResult.getProducts().get(0).getPrices().stream().filter(price -> price.getCurrency().equals(DEFAULT_CURRENCY)).findAny().get().getValue().doubleValue())))
                    .andExpect(jsonPath("$.orderedProducts[0].price[0].currency", is(expectedOrderResult.getProducts().get(0).getPrices().stream().filter(price -> price.getCurrency().equals(DEFAULT_CURRENCY)).findAny().get().getCurrency().toString())))
                    .andExpect(jsonPath("$.orderedProducts[0].price[0].isOriginal", is(false)))

                    .andExpect(jsonPath("$.orderedProducts[0].priceSummary", hasSize(1)))
                    .andExpect(jsonPath("$.orderedProducts[0].priceSummary[0].value").value(expectedOrderResult.getProducts().get(0).getPriceSummary().stream().filter(price -> price.getCurrency().equals(DEFAULT_CURRENCY)).findAny().get().getValue().doubleValue()))
                    .andExpect(jsonPath("$.orderedProducts[0].priceSummary[0].currency", is(expectedOrderResult.getProducts().get(0).getPriceSummary().stream().filter(price -> price.getCurrency().equals(DEFAULT_CURRENCY)).findAny().get().getCurrency().toString())));
    ...
    class DeleteOrderById {
        ...
        void shouldDeleteOrderById() throws Exception {
            ...
            // then
            mockMvc.perform(MockMvcRequestBuilders.delete("/orders" + "/" + expectedOrderResult.getId().toString()).contentType(DATA_FORMAT_JSON))
            ...
            assertThat(deletedOrder.getCreatedAt()).isNotNull();
            assertThat(deletedOrder.getLastModifiedAt()).isNotNull();
            assertThat(deletedOrder.getProducts()).containsExactlyInAnyOrderElementsOf(expectedOrderResult.getProducts());
            assertThat(deletedOrder.getPrices()).containsExactlyInAnyOrderElementsOf(expectedOrderResult.getPrices());
            assertThat(deletedOrder.getPriceSummary()).containsExactlyInAnyOrderElementsOf(expectedOrderResult.getPriceSummary());
        ...
        void shouldNotDeleteOrderById_whenOrderIsAlreadyDeleted() throws Exception {
            ...
            // then
            mockMvc.perform(MockMvcRequestBuilders.delete("/orders" + "/" + ID).contentType(DATA_FORMAT_JSON))
                    .andExpect(MockMvcResultMatchers.status().isNotFound())
                    .andExpect(MockMvcResultMatchers.content().contentType(DATA_FORMAT_JSON));
        }
    ...
    class DeleteOrdersByIds {
        ...
        void shouldDeleteOrdersByIds() throws Exception {
            ...
            // then
            mockMvc.perform(MockMvcRequestBuilders.delete("/orders" + "/remove").contentType(DATA_FORMAT_JSON).content(objectMapper.writeValueAsString(orderIds)))
                    .andExpect(MockMvcResultMatchers.status().isNoContent());
            ...
            deletedOrders.forEach(deletedOrder -> {
                ...
                assertThat(deletedOrder.getPrices()).containsExactlyInAnyOrderElementsOf(orderToCompare.getPrices());
                assertThat(deletedOrder.getPriceSummary()).containsExactlyInAnyOrderElementsOf(orderToCompare.getPriceSummary());
                assertThat(deletedOrder.isDeleted()).isTrue();
            });
        }
    ...
    class CreateOrder {
        ...
        void shouldCreateNewOrder() throws Exception {
            ...
            // then
            mockMvc.perform(MockMvcRequestBuilders.post("/orders").contentType(DATA_FORMAT_JSON).content(objectMapper.writeValueAsString(request)))
                    .andExpect(MockMvcResultMatchers.content().contentType(DATA_FORMAT_JSON))
        ...
        @Test
        void shouldReturnBadRequest_whenCustomPriceValueIsNull() throws Exception {
            // given
            final var expectedProduct = OrderHelper.createProduct();
            final var request = OrderHelper.createOrderRequest(ORDER_NAME, expectedProduct, 1.0);
            request.getOrderedProducts().get(0).getPrice().setValue(null);
    ...
    class UpdateOrder {
        ...
        void shouldNotUpdateOrder_whenProductQuantityIsEqualToZero() throws Exception {
            ...
            // then
            mockMvc.perform(MockMvcRequestBuilders.patch("/orders" + "/" + expectedOrderResult.getId().toString()).contentType(DATA_FORMAT_JSON).content(objectMapper.writeValueAsString(updateRequest)))
                    .andExpect(MockMvcResultMatchers.status().isBadRequest())
                    .andExpect(MockMvcResultMatchers.content().contentType(DATA_FORMAT_JSON));
        ...
        void shouldNotUpdateOrder_whenOrderDoesNotExists() throws Exception {
            ...
            // then
            mockMvc.perform(MockMvcRequestBuilders.patch("/orders" + "/" + ID).contentType(DATA_FORMAT_JSON).content(objectMapper.writeValueAsString(updateRequest)))
                    .andExpect(MockMvcResultMatchers.status().isNotFound())
                    .andExpect(MockMvcResultMatchers.content().contentType(DATA_FORMAT_JSON));
        ...
        void shouldUpdateOrder() throws Exception {
            ...
            mockMvc.perform(MockMvcRequestBuilders.patch("/orders" + "/" + expectedOrderResult.getId().toString()).contentType(DATA_FORMAT_JSON).content(objectMapper.writeValueAsString(updateRequest)))
                    ...
                    .andExpect(jsonPath("$.orderedProducts[1].createdAt").isNotEmpty())
                    .andExpect(jsonPath("$.orderedProducts[1].lastModifiedAt").isNotEmpty())

                    .andExpect(jsonPath("$.orderedProducts[1].price", hasSize(1)))
                    .andExpect(jsonPath("$.orderedProducts[1].price[0].value", is(expectedOrderResult.getProducts().get(1).getPrices().get(0).getValue().doubleValue())))
                    .andExpect(jsonPath("$.orderedProducts[1].price[0].currency", is(expectedOrderResult.getProducts().get(1).getPrices().get(0).getCurrency().toString())))
                    .andExpect(jsonPath("$.orderedProducts[1].price[0].isOriginal", is(expectedOrderResult.getProducts().get(1).getPrices().get(0).isPriceOriginal())))
